...
import me.signatured.vpnguarddatabase.information_schema.tables.records.EventsRecord;
...
public class Events extends TableImpl<EventsRecord> {
    ...
    private static final long serialVersionUID = -1740172337;
     ...
     */
    public final TableField<EventsRecord, String> DEFINER = createField("DEFINER", org.jooq.impl.SQLDataType.VARCHAR.length(93).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
